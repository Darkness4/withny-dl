...
## Retry delay on login failure.
loginRetryDelay: 60s
## Impersonate a browser user agent. (default: '', means will use a random browser user agent)
## Example: Mozilla/5.0 (X11; Linux x86_64; rv:144.0) Gecko/20100101 Firefox/144.0
userAgent: ''
